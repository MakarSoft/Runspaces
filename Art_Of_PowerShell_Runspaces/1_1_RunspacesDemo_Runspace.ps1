...
# Используйте [powershell] для создания экземпляра PowerShell в процессе с уже созданной рабочей областью
...
[powershell]::Create().AddCommand("Get-ChildItem").AddParameter('Filter','*.PS1').AddParameter('Path','C:\Users\boepr\desktop\Art_Of_PowerShell_Runspaces').Invoke()
